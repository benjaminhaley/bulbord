...
function MemberComments({ sportsClubId, source }: { sportsClubId: string; source: { id: string; name: string } | null }) {
...
export function CommentsSection(props: { sportsClubId: string; source: { id: string; name: string } | null }) {
  const { user } = useAuth()
